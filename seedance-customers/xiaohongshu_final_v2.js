  ...
  try {
    ...
    for (const keyword of KEYWORDS) {
      ...
      try {
        ...
        // 截图
        const screenshotPath = path.join(WORK_DIR, `xiaohongshu_v2_${keyword}.png`);
    ...
    // 保存结果
    const resultsPath = path.join(WORK_DIR, 'xiaohongshu_v2_results.json');
